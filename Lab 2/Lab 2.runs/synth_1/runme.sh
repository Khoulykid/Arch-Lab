...
HD_PWD='C:/Users/khoulykid/Desktop/Lab 2/Lab 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopExp3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopExp3.tcl
